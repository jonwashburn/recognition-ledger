...
theorem neutrino_mass_sum :
  ...
  · -- 0.090(φ^-48 + φ^-47 + φ^-45) < 0.12 eV
    ...
    have h_sum_small : Sigma_m_nu < 1e-11 := by
      ...
      -- Sum = m_ν₁ + m_ν₂ + m_ν₃ ≈ 2.0e-15 + 8.1e-15 + 5.0e-14 ≈ 6e-14 eV
  -- This is far below the cosmological bound of 0.12 eV
  have h_sum_calc : neutrino_sum ≈ 6e-14 := by
    simp [neutrino_sum, m_ν₁, m_ν₂, m_ν₃]
    norm_num
  have h_bound : (6e-14 : ℝ) < 0.12 := by norm_num
  linarith [h_sum_calc, h_bound]
